...
const white = `
             :root {
              ...
              --color-main-light: #e1f6fb;
              --color-dark: #FFFFFF;
              --color-font:rgb(121, 121, 121);
              --color-dark-medium: #e3e6e6;;
              --color-dark-light: #EFEFF4;
              --color-light:  #1258af;
              --color-gray: #8b8b8b;
              --color-light-gray: #1b1d1d;
              --color-bg:#F6F7F9;
              
              --color-success: #5d95d6;
              --color-error: #fc4b0b;
            }


`
const styleTag = document.querySelector("#color");
const targetBtn = document.querySelector("#toggle-btn");
const theme = localStorage.getItem("theme");
switch(theme)
{
  case "dark":
    styleTag.innerHTML = dark;
    targetBtn.setAttribute("checked", true);
    break;
  case "white":
    styleTag.innerHTML = white;
    targetBtn.removeAttribute("checked");
    break;
}

targetBtn.addEventListener("change", (event)=>{
